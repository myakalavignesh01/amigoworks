      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        >
          ...
          <p className="mt-4 md:mt-0 text-sm md:text-base text-white/60 max-w-md font-light">
            A battle-tested 6-stage development system ensuring rapid turnaround, rock-solid stability, and transparent iteration.
          </p>
        </motion.div>
        ...
        <motion.div
          ...
          className="mt-12 p-6 rounded-2xl bg-[#0E0E0E] border border-white/10 flex flex-col sm:flex-row items-center justify-between gap-4"
        >
